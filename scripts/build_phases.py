    ...
    for artifact_type, subdir_name in _MANAGED_ARTIFACT_DIRS.items():
        ...
        for item in sorted(managed_dir.iterdir()):
            ...
            try:
                ...
                _log.warning("Failed to remove stale artifact %s: %s", item, exc)
                raise
...
# - 2026-09-14 [python-coder]: Moved validate_agent_self_description and
#   _self_desc_field_hint to build_agent_self_description.py (re-exported
#   here) so this file shrinks back under the check-file-size ratchet. Pure
#   move, no behaviour change. (#BP-1500g-1/extract-unrelated-headroom)
# ====================================================================
