---
description: Drive a single standalone ticket (not part of an epic) through its phase
  agents. Moves the ticket file from 00_inbox → 01_todo, creates an isolated worktree,
