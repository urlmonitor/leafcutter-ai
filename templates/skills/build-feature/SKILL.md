...
# build-feature — Knowledge Items

This skill file collects operational knowledge items (KIs) discovered during
real epic drives. It is the companion to `.agents/workflows/build-feature.md`
...
`.agents/workflows/build-feature.md` Step A step 6) will surface this
...
to .claude/skills/build-feature/SKILL.md but had not yet signed off.
Uncommitted diff:
...
- `.agents/workflows/build-feature.md` — executable workflow; Step A step 6
