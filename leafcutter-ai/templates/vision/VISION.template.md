...
<!-- QUESTION: Which numbered phase are we currently in (see docs/roadmap.json)?
...
> **Delivery Plan**: See [docs/roadmap.json](../docs/roadmap.json) for phases, exit criteria,
> and the current highest-priority outcome. Edit that file — not this section — to update
> the roadmap.
