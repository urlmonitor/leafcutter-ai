...
| 07 | [07_tdd_documentation.md](./07_tdd_documentation.md) | Author explanation doc "How TDD works in leafcutter" + how-to "Writing a TDD ticket" + ADR-027 for workflow change | `[ ]` |
