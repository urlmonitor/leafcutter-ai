"""
build_ac_mode_detection — mode detection helper for the build-ac agent.

Implements the three-way routing branch described in ticket 05 of EPIC-GoalToEpic:
...
This module is a pure detection utility: it reads the level and covered_by fields
and returns a routing dict. It does NOT invoke any pipeline steps — those are the
