...
description: Query ticket alignment against docs/roadmap.json. Use when you need to
  see which tickets advance the current phase outcome, list all tickets by phase (rollup),
  or identify tickets with no roadmap_phase assigned.
name: roadmap-query
portable: true
---
