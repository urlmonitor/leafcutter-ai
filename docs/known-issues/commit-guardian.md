...
- **Status:** open. Specified but not built: `GE-127e-3` ("The refusal offers only help that actually arrives, and a bare verdict is preferred to a promise nothing keeps") was authored 2026-09-08 against exactly this shape, and its first descriptor is written to be applied to this message. The AC exists; the fix does not.
