---
description: "Meta-agent that owns the leafcutter package surface area. Manages\n\
  ...
  \ (promote a project-local agent), \nadd-skill-to-package (promote a project-local\
  \ skill), and \npackage-audit (surface package gap analysis). Use when adding new\
