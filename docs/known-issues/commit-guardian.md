...
| `high` | KI-CG-20260923-ratchet-has-no-escape-for-unsplittable-files — the file-size ratchet's only remedy is extraction, which a workflow body cannot do, so an over-limit one can never accept a fix | [open-high-ki-cg-20260923-ratchet-has-no-escape-for-unsplittable-files.md](commit-guardian/open-high-ki-cg-20260923-ratchet-has-no-escape-for-unsplittable-files.md) |
