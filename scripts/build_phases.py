...
#   (#BP-1000a-7)
# - 2026-09-14 [python-coder/KI-BP-010]: Fixed _MANAGED_ARTIFACT_DIRS["workflows"] (".claude/workflows" -> "workflows", joined onto claude_dir which is already target_dir/".claude"; the old value built a never-existent ".claude/.claude/workflows" so exists() skipped the sweep every clean run -- orphan survived pre-fix, removed=1 after; path-join only, promoting the sweep onto the default build path stays BP-1500b-1's scope).
#   Also added roadmap.schema.json to the commit-guardian config deploy, required once KI-CG-010 fixed its resolvable path for the BP-900g-8 closure guard. (#KI-BP-010, covered_by: BP-1500b-1)
# ====================================================================
