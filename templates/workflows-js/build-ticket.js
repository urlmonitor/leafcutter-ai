...
async function readTicketRecordBack(recordPath) {
  return await agent(
    ...
    `Otherwise return {"readable": true, "ticket_path": "${recordPath}", "lifecycle_status": "...", "needed_phases": [...], "signoffs": [{"agent": "...", "status": "...", "handoff_target": "..."}, ...], "signed_off_agents": [...]}. ` +
...
return await concludeTicket({
  ...
  title,
  record: lastRecord,
  // BO-3701: the opening set PLUS anything genuinely promoted mid-drive. A
