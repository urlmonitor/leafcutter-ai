...
#   on orchestration.
# - 2026-07-10 [claude/revive]: Re-landed _validate_live_surface_testing() and wired it
#   into validate_config() during EPIC-LiveSurfaceTesting revival. Validates enabled
#   (bool), startup_command (non-empty when enabled=true), and port_range_start <
#   port_range_end. Absence of the key is valid (treated as enabled: false).
#   (#EPIC-LiveSurfaceTesting)
# ====================================================================
