...
| `high` | KI-ACD-20260921-1615 — An AC's `expects_from` edge is dropped from the generated ticket whenever that same AC's `delivers_to` is null, so terminal leaves lose their dependencies | [open-high-ki-acd-20260921-1615.md](ac-driven-dev/open-high-ki-acd-20260921-1615.md) |
