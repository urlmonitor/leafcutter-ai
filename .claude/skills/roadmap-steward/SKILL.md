...
description: Wraps roadmap_query.py --audit to produce a structured audit_result JSON
  for the product-owner-agent. Use when you need to identify starved roadmap phases
  (no open tickets), off-roadmap open tickets, and a full phase inventory.
