---
title: "Known issues — build-orchestration: fabricated evidence pointers"
description: "Full write-up of KI-BO-20260908-1030, extracted from build-orchestration.md to keep that file under its line-length limit. Covers the fast lane's unchecked self-reported tests_written/files_modified fields."
type: reference
category: reference
status: active
created: 2026-09-14
...
> **Parent document:** [build-orchestration.md](build-orchestration.md)

# Known issues — build-orchestration: fabricated evidence pointers
