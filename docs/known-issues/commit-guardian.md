...
- **Status:** open — no AC. Bypassed once via `SKIP=check-file-size` on the merge commit only; the gate remains fully in force for ordinary commits.
