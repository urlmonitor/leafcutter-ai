...
description: Full-repo glossary bootstrap. Scans all .md/.py/.sql files for novel
  jargon candidates, dispatches the glossary-triage agent in parallel batches, applies
  decisions to docs/glossary.md and docs/glossary_blacklist.md, and commits the result.
  Run once after initial install or after a significant codebase merge.
