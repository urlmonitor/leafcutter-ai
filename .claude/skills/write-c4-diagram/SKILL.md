...
description: 'Use when asked to write, create, or update an architecture diagram or
  architecture documentation. Triggers include: "write an arch doc", "document the
  X component", "create the L2 diagram", "add architecture docs for X", "draw a C4
  diagram", "write a sequence diagram for Y", "create an ERD for Z". Always invoke
