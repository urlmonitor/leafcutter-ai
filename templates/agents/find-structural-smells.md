...
- name: Conditional Behavior
  trigger: the code is clean and no structural smell can be anchored to concrete lines
  behavior: state briefly that the target was scanned against all six structural smells and none were found, then return an empty findings set
  related_agent: null
