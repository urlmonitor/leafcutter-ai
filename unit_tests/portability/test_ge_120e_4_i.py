...
def _init_repo(repo: Path) -> None:
    # `git init -q` is invoked with cwd=repo, so the directory has to exist
    # first. Without this the fixture died with
    # "RuntimeError: git init -q failed in <path>: [Errno 2] No such file or
    # directory", which reads like a git failure but is a missing mkdir — and
    # it made all four tests in this file fail regardless of how correctly
    # GE-120e-4 was implemented.
