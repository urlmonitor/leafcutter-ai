...
| `scripts/commit_guardian/` | `leafcutter/templates/scripts/commit_guardian/` |
...
- [ ] `CLAUDE.md` exists (compiled from `templates/CLAUDE.md.template`) and `.gemini/instructions.md` exists (compiled from `templates/ANTIGRAVITY.md.template`)
