...
| 09 | [09_worktree_guard_in_workflows.md](./09_worktree_guard_in_workflows.md) | Add worktree guard and auto-creation logic to build-epic.js and build-ticket.js | `[ ]` |
