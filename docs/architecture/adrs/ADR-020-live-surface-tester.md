---
title: 'ADR-020: Live Surface Tester — Port Registry, Read-Only Constraint, and Conditional
  Dispatch'
type: adr
status: accepted
created: '2026-06-03'
...
related_code: []
description: 'Overview of ADR-020: Live Surface Tester — Port Registry, Read-Only
  Constraint, and Conditional Dispatch.'
---
...
> and are reconciled by the revival tickets — see EPIC-LiveSurfaceTesting.
