---
description: |
  Invoke the Product Owner agent for L0/L1 AC authoring. Scans the existing
...
Invoke the `product-owner` agent with the following context:

**User request:** $ARGUMENTS

**Instructions for the PO agent:**
...
5. Set `origin_agent: product-owner` on all ACs you create.
6. Do NOT go below L1 — the BA agent handles L2/L3 decomposition.
