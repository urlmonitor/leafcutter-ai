...
description: 'Promote a project-local agent into the leafcutter package atomically.
  Moves the agent template, registers it in agent_registry.json, and updates docs/agents/README.md.
