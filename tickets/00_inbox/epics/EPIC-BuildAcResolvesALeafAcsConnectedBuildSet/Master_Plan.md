...
This epic implements AC BO-2600a: build-ac resolves a leaf AC's connected build set and generates the whole set in dependency order. It consists of 4 ticket(s) generated from the leaf ACs beneath BO-2600a, assembled in topological build order with all inter-ticket dependencies derived from the AC depends_on graph.
...
| 04 | [04_TICKET-20260811-BO-2600a-4.md](./04_TICKET-20260811-BO-2600a-4.md) | build-ac emits a dependency-ordered epic when the connected build set has more than one AC | BO-2600a-4 | BO-2600a, BO-2600a-2 |
...
| architect-review | 01 |
| commit | 01, 02, 03, 04 |
| documentation-expert | 01, 03, 04 |
| documentation-verifier | 01, 03, 04 |
| llm-expert | 03, 04 |
| pr-reviewer | 01, 03, 04 |
